...
def main():
    ...
    #expand_emotion_seeds(emotion_seeds, danmu2vec, 0.05, 0.6) # first time expansion
    emotion_seeds = read_expanded_seeds()
    #expand_emotion_seeds(emotion_seeds, danmu2vec, 0.1, 0.8) # second time expansion
    #expand_emotion_seeds(emotion_seeds, danmu2vec, 0.05, 0.6)  # third time expansion
    expand_emotion_seeds(emotion_seeds, danmu2vec, 0.1, 0.8)  # third time expansion
    #print_top_n_words(5000)
    #train_emotion_classifier(danmu2vec)
